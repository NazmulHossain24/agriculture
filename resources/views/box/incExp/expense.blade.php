        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Add New Expense</h5>
                </div>

                <form action="{{action('ExpenseController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Expense Name:</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="name" placeholder="Expense Name" type="text" required>
                            </div>
                        </div><br>
                    </div>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ExpenseController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
