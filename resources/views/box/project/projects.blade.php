        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Add New Project</h5>
                </div>

                <form action="{{action('ProjectController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Project Name:</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="name" placeholder="Project Name" type="text" required>
                            </div>
                        </div><br>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ProjectController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
