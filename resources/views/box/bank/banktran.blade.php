    ...
    <div id="depositModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('BankTransactionController@deposit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="amountIN" placeholder="Deposit Amount" type="number" required>
                        </div><br>
                        <div class="form-group">
                            <label>Deposit Description <span class="text-sm text-muted">Deposit Slip Number or any thing</span></label>
                            <textarea class="form-control" name="description" rows="3" placeholder="Deposit Slip Number or writing any thing ..."></textarea>
                        </div><br>
                    </div>
    ...
    <div id="withdrawModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('BankTransactionController@withdraw')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="input-group">
                            <span class="input-group-addon">Bank A/C </span>
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="amountOut" placeholder="Withdraw Amount" type="number" required>
                        </div><br>

                        <div class="form-group">
                            <label>Withdraw Description <span class="text-sm text-muted">Cheque Number or any thing</span></label>
                            <textarea class="form-control" name="description" rows="3" placeholder="Cheque Number or any thing ..."></textarea>
                        </div><br>
