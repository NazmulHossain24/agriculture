    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ExpenseTransactionController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea style="margin-bottom: 21px;" class="form-control" rows="5" name="description" placeholder="Description Here..." required></textarea>
                            </div>
                        </div><br>
                    </div>
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('ExpenseTransactionController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
